...
export declare namespace g {
    ...
    const optional: (Group_Part: _pi.Optional_Value<_target.Group.L>) => _target.Group_Part;
}
export declare namespace b {
    ...
    const optional: (block_part: _pi.Optional_Value<_target.Block.L>) => _target.Block_Part;
}
