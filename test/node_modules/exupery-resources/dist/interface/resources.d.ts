...
export declare namespace commands {
    ...
    type execute_any_command_executable = _pi.Command<d_execute_any_command_procedure.Error, d_execute_any_command_procedure.Parameters>;
    type execute_any_smelly_command_executable = _pi.Command<d_execute_any_smelly_command_procedure.Error, d_execute_any_smelly_command_procedure.Parameters>;
    type execute_smelly_command_executable = _pi.Command<d_execute_smelly_command_procedure.Error, d_execute_smelly_command_procedure.Parameters>;
    type execute_command_executable = _pi.Command<d_execute_command_procedure.Error, d_execute_command_procedure.Parameters>;
    type log = _pi.Command<null, d_log.Parameters>;
    type log_error = _pi.Command<null, d_log_error.Parameters>;
    type main = _pi.Command<d_main.Error, d_main.Parameters>;
    type make_directory = _pi.Command<d_make_directory.Error, d_make_directory.Parameters>;
    type remove = _pi.Command<d_remove.Error, d_remove.Parameters>;
    type write_directory_content = _pi.Command<d_write_directory_content.Error, d_write_directory_content.Parameters>;
    type write_file = _pi.Command<d_write_file.Error, d_write_file.Parameters>;
    type write_to_stderr = _pi.Command<null, d_write_to_stderr.Parameters>;
    type write_to_stdout = _pi.Command<null, d_write_to_stdout.Parameters>;
}
